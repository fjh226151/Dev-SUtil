...
//        calendar.set(Calendar.MINUTE, 59);
        ...
        fun getCurrentTimeMonth(data: Long): String {
            return SimpleDateFormat("MM月").format(data)
        }
        ...
        fun getCurrentTime_YMD(long: Long): String {
            return SimpleDateFormat("yyyy-MM-dd").format(Date(long))
        }
        fun getCurrentTime_YMD_HMS(long: Long): String {
        ...
        fun timeToLineYMDHM(long: Long): String {
            return SimpleDateFormat("yyyy-MM-dd HH:mm").format(Date(long))
        }
        ...
        fun timeToChinaYMD(time: String, oldValue: String): String {
            return if (time.contains(oldValue)){
                val t = time.split(oldValue)
                if (t.size==3){
                    "${t[0]}年${t[1]}月${t[2]}日"
                }else{
                    time
        ...
        /**
         * eg 2023-03-02 12:22:2
         */
        fun timeToChinaYMDHM(time: String, oldValue: String): String {
            return if (time.contains(oldValue)&&time.contains(" ")){
                var times = time.split(" ")
                val t = times[0].split(oldValue)
                if (t.size==3){
                    "${t[0]}年${t[1]}月${t[2]}日 ${times[1]}"
                }else{
                    time
                }
            }else{
